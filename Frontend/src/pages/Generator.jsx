                ...
                <div className="w-full max-w-4xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-slate-300 max-w-2xl mx-auto">
                            Describe what you want to master and let our AI create a customized
                            roadmap tailored to your skill level.
                        </p>
                    </div>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-8">
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-sm text-slate-400 ml-7">
                                            Be specific about the technology, language, or skill you
                                            want to master
                                        </p>
                                        <textarea
                                            id="description"
                        ...
                        <div className="lg:col-span-1 space-y-4">
                            ...
                            <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 border border-purple-500/30 rounded-xl p-6 backdrop-blur-sm hover:border-purple-400/50 transition-all duration-300">
                                ...
                                <p className="text-sm text-slate-400">
                                    Clear milestones and learning steps
                                </p>
                            </div>
