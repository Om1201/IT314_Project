  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        <p className="text-gray-300 text-lg font-medium text-center">Loading your roadmaps...</p>

        <div className="flex gap-3 items-center">
          <div className="w-2 h-2 bg-white rounded-full animate-bounce" style={{ animationDelay: "0s" }}></div>
          <div className="w-2 h-2 bg-[#015670] rounded-full animate-bounce" style={{ animationDelay: "0.2s" }}></div>
