...
export default function LeftSidebar({
  ...
  return (
    <aside className="w-80 bg-slate-900/40 backdrop-blur-xl -r border-blue-500/30 overflow-y-auto p-6">
      ...
      <div className="mb-8">
        <h3 className="text-sm font-semibold text-white mb-3 uppercase tracking-wide">Stopwatch</h3>
      ...
      <div className="mb-8">
        <h3 className="text-sm font-semibold text-white mb-3 uppercase tracking-wide">Timer</h3>
